...
$boarding_points = array_filter(array_map('trim', explode(',', $trip['boarding_points'])));
...
<section class="seat-selection-page">
    <div class="container" id="seatSelectionContent">
        ...
        <div class="seat-layout">
            <div class="seat-grid-wrapper">
                ...
                <form id="seatForm" class="seat-grid-container">
                    ...
                    <input type="hidden" id="tripFarePerSeat" value="<?php echo $trip['fare']; ?>">
